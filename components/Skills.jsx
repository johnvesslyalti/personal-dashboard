...
export default function Skills() {
    ...
    return(
        <div id="skills" className="min-h-screen flex px-5 py-16">
            <div className="w-full">
                <motion.div 
                    ...
                    viewport={{ once: false }}
                    ><h1 className="text-xl font-bold text-center">Skills</h1></motion.div>
                <div className="grid grid-cols-2 my-auto sm:grid-cols-3 md:grid-cols-5 gap-5 mt-10">
                    {skills.map((skill) => (
                        <motion.div
                        key={skill.id}
                            initial={{ opacity: 0, y: 30 }}
